...
LOGOUT_REDIRECT_URL = "/"  # logout ke baad
# settings.py
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",   # project root/static/
]
STATIC_ROOT = BASE_DIR / "staticfiles"  # collectstatic ke liye (production use)

# Media files (uploads)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / "media"   # project root/media/
